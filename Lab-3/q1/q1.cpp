...
int main()
{
    ...
    in the above code we use divide and conquer method to multiply 2 matrices by dividing it into 8 subparts. here T(n)=8T(n/2)+O(n^2). using master's theorem T(n)=O(n^3).d
    */
} 